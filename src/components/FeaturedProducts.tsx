    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-3xl font-bold text-foreground mb-2 font-playfair bg-gradient-to-r from-primary to-blue bg-clip-text text-transparent">{props?.title} Products</h2>
